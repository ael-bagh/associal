...
<form action="/" accept-charset="UTF-8" method="post">
	<input class="w-full shadow-inner p-4 border-0 mb-2 rounded-lg focus:shadow-outline text-2xl" type="text" placeholder="Nom et prenom">
	<input class="w-full shadow-inner p-4 border-0 mb-2 rounded-lg focus:shadow-outline text-2xl" type="text" placeholder="Adresse email">
  	<textarea class="w-full shadow-inner p-4 border-0 mb-4 rounded-lg focus:shadow-outline text-2xl" placeholder="Commentaire." cols="6" rows="6" id="comment_content" spellcheck="false"></textarea>
  	<button class="font-bold py-2 px-4 w-full bg-green-400 text-lg text-white shadow-md rounded-lg ">Comment </button>
</form>
...
<div class="bg-white rounded-lg p-3  flex flex-col justify-center items-center md:items-start shadow-lg mb-4">
  <div class="flex flex-row justify-center mr-2">
    ...
    <h3 class="text-green-600 font-semibold text-lg text-center md:text-left ">@Shanel</h3>
  </div>
