...
<html>
	<head>
		<title>association marocaine de lutte contre tabagisme et drogues</title>
		<meta charset="utf-8" />
	...
	<body class="landing">
		...
		<!-- Header -->
			<header id="header" class="alt">
				<h1><strong><a href="index.html"></a></strong> AMLCTD</h1>
				<nav id="nav">
					<ul>
						<li><a href="index.html">L'association</a></li>
						<li><a href="generic.html">Activites</a></li>
		...
		<!-- Banner -->
			<section id="banner">
				<h2><img width="100" height="100" src="images/logo.png" alt=""></h2>
				<p>Nous luttons<br /> pour l’avenir de nos enfants et celui de notre pays</p>
				<ul class="actions">
					<li><a href="#" class="button special big">Faire un don</a></li>
				</ul>
			</section>
				...
				<section id="one" class="wrapper style1">
					<div class="container 75%">
						<div class="row 200%">
							...
							<div class="6u$ 12u$(medium)">
								<p>Créée le 5 Juillet 2009 une association civile marocaine opérant à l’échelle national à but non lucratif et sans aucune appartenance politique ni religieuse.
			...
			<!-- Two -->
				<section id="two" class="wrapper style2 special">
					<div class="container">
						<header class="major">
							<h2>Activites</h2>
							<p>compagnes de sensibilisation</p>
						</header>
						<div class="row 150%">
							...
							<div class="6u$ 12u$(xsmall)">
								<div class="image fit captioned">
									...
									<a href=""><h3>titre</h3></a>
								</div>
							</div>
						</div>
						<ul class="actions">
							<li><a href="#" class="button special big">Voir tous les activites</a></li>
						</ul>
					</div>
				</section>
			...
			<footer id="footer">
				<div class="container">
					...
					<ul class="copyright">
						...
						<li>Backend: <a href="http://ael-bagh.github.io">Anas El baghdadi</a></li>
					</ul>
				</div>
			</footer>
