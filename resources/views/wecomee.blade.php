...
<body class="bg-white">
    <!-- component -->
    <div class="flex flex-row-reverse items-center bg-white border-b-2 border-green-200">
    ...
    <nav class="bg-white shadow-lg">
        <div class="md:flex items-center justify-between py-2 px-8 md:px-12">
            ...
            <div class="flex flex-col md:flex-row -mx-2 md:block hidden"  id="myTopnav">
                ...
                <a href="#" class="text-gray-800 rounded hover:bg-gray-900 hover:text-gray-100 hover:font-medium py-2 px-2 md:mx-2">Articles</a>
                <a href="#" class="text-gray-800 rounded hover:bg-gray-900 hover:text-gray-100 hover:font-medium py-2 px-2 md:mx-2">Blog</a>
            </div>
        </div>
    </nav>
...
<div>
      ...
      <div class="lg:flex items-center container mx-auto my-auto">
        ...
        <div class="lg:m-4 shadow-md hover:shadow-lg hover:bg-gray-100 rounded-lg bg-white my-12 mx-8">
          ...
          <div class="p-4">
            ...
            <p class="text-justify">Author: Anas El baghdadi</p>
            <div class="mt-5">
  ...
  <div class="relative items-center justify-center">
    <h1 class="text-center text-2xl font-bold p-4 bg-gray-800 text-gray-400">Nos dernieres Actvites</h1>
      <div class="lg:flex items-center container mx-auto my-auto">
        <!-- component -->
<div class="lg:m-4 bg-white shadow-lg rounded-lg overflow-hidden my-12 mx-8">
